...
public class AclControlFilter implements Filter {
    ...
    private static Logger log = LoggerFactory.getLogger(AclControlFilter.class);

    private static Set<String> exclusionUrlSet = Sets.newConcurrentHashSet();

    private final static String noAuthUrl = "/sys/user/noAuth.do";
