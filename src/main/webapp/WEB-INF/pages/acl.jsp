...
<script type="text/javascript">
    $(function() {
        ...
        function updateAclModule(isCreate, successCallback, failCallback) {
            $.ajax({
                url: isCreate ? "/sys/aclModule/save.php" : "/sys/aclModule/update.php",
        ...
        function updateAcl(isCreate, successCallback, failCallback) {
            $.ajax({
                url: isCreate ? "/sys/acl/save.php" : "/sys/acl/update.php",
        ...
        function loadAclList(aclModuleId) {
            ...
            var url = "/sys/acl/page.php?aclModuleId=" + aclModuleId;
