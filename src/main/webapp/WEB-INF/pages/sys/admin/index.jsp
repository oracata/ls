...
<div class="main-container" id="main-container">
    ...
    <div id="sidebar" class="sidebar responsive">
        ...
        <ul class="nav nav-list">
            ...
            <li class="">
                ...
                <ul class="submenu">
                    <li class="">
                        <a class="popstyle" href="/sys/dept/dept.do" target="_blank">
                    ...
                    <li class="">
                        <a class="popstyle" href="/sys/role/role.do" target="_blank">
                            <i class="menu-icon fa fa-caret-right"></i>
                            角色管理
                        </a>
                        <b class="arrow"></b>
                    ...
                    <li class="">
                        <a class="popstyle" href="/sys/aclModule/acl.do" target="_blank">
                            <i class="menu-icon fa fa-caret-right"></i>
                            权限管理
                        </a>
                        <b class="arrow"></b>
                    ...
                    <li class="">
                        <a class="popstyle" href="/sys/log/log.do" target="_blank">
                            <i class="menu-icon fa fa-caret-right"></i>
                            权限更新记录
                        </a>
                        <b class="arrow"></b>
            ...
            <li class="">
                ...
                <ul class="submenu">
                    <li class="">
                        <a class="popstyle" href="/config/config.do" target="_blank">
                            <i class="menu-icon fa fa-caret-right"></i>
                            全局配置管理
                        </a>
                        <b class="arrow"></b>
    ...
    <div class="main-content">
        <iframe id="innerFrame" src="/sys/dept/dept.do" width="99%" style="min-height: 768px;"></iframe>
    </div>
    <!-- /.main-content -->
